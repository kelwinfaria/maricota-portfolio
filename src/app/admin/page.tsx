    ...
    <div id="app" className="ready">
      ...
      <div className="main">
        ...
        <div className="pc">
          ...
          {d.page === 'colecoes' && <CollectionsSection colTab={d.colTab} setColTab={d.setColTab} carousel={d.carousel} especiais={d.especiais} products={d.products} cats={d.cats} onSaveCarousel={d.saveCarousel} onSaveEspeciais={d.saveEspeciais} onAddSlot={d.setSlotMode} onSetEspecialCover={d.setEspecialCover} onRemoveEspecialCover={d.removeEspecialCover} newCat={d.newCat} setNewCat={d.setNewCat} onAddCat={d.addCat} onRemoveCat={d.removeCat} renamingCat={d.renamingCat} renameVal={d.renameVal} setRenamingCat={d.setRenamingCat} setRenameVal={d.setRenameVal} onRenameCat={d.renameCat} />}
